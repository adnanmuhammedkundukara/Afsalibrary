...
@Afsalibrary.on_message(Worker.command('delete') & Worker.user(ADMINS))
...
@Afsalibrary.on_message(Worker.command('deleteall') & Worker.user(ADMINS))
...
@Afsalibrary.on_callback_query(Worker.regex(r'^autofilter_delete'))
