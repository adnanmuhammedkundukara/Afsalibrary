...
from Afsalibrary.database.autofilter_db import is_subscribed, get_file_details
from Afsalibrary.database._utils import get_size
...
@Afsalibrary.on_callback_query()
async def cb_handler(client: Afsalibrary, query):
...
# ---------- 📁 [ | 𝗚𝗘𝗧 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
        ...
        elif query.data.startswith("Afsalibrary"):
...
# ---------- 📁 [ | 𝗣𝗠 𝗙𝗜𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            for files in filedetails:
                ...
                buttons = [[
                  InlineKeyboardButton('MORE BOOKS', url='https://t.me/EBOOKS_MALAYALAM_EBOOKS')
                  ]]                 
...
# ---------- 📁 [ | 𝗠𝗢𝗗𝗨𝗟𝗘𝗦 | ] 📁 ---------- #
            ...
            if query.from_user.id not in ADMINS: 
                buttons = [[
                 ...
                 InlineKeyboardButton("MORE BOTS", url="T.ME/ebooksdlsbot"),
                 InlineKeyboardButton("🤖 Update", url="https://t.me/ALIFDRIVE")
                 ]]
            else:
                buttons = [[
                 InlineKeyboardButton("➕️ Add me to Your Chat ➕️", url=f"http://t.me/{bot_info.BOT_USERNAME}?startgroup=true")
            ...
            await query.message.edit(text=Afsalibrary.HELP_MSG.format(mention=query.from_user.mention), reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            await query.message.edit(text=Afsalibrary.ABOUT_MSG.format(mention=query.from_user.mention, bot_name=bot_info.BOT_NAME, bot_username=bot_info.BOT_USERNAME, dev_name=DEV_NAME), reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
            ...
            await query.message.edit(text=Afsalibrary.adnanmuhammedkundukara.format(mention=query.from_user.mention), reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
